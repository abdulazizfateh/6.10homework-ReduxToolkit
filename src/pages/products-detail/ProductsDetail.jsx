            ...
            <div className='container mx-auto'>
                <div className='product_detail_wrapper grid grid-cols-[2fr_1fr] grid-rows-[110px_110px_110px_110px_110px_110px] max-lg:grid-cols-1 max-md:grid-rows-[85px_85px_85px_85px_85px_85px] max-sm:grid-rows-[65px_65px_65px_65px_65px_65px] gap-5'>
                    ...
                    <div className='bg-secondary-bg row-span-4 rounded-xl border border-border overflow-hidden flex flex-col'>
                        ...
                        <div className='py-3 max-md:py-2 max-md:px-2.5 px-3.5 border-b border-border'>
                            <p className='text-sm max-md:text-[11px]'><span className='text-secondary-text'>Brand:</span> {data?.brand}<span></span></p>
                        </div>
                        <div className='py-3 max-md:py-2 max-md:px-2.5 px-3.5 border-b border-border'>
                            <p className='text-sm max-md:text-[11px]'><span className='text-secondary-text'>Availability status:</span> {data?.availabilityStatus}</p>
                        </div>
                        <div className='py-3 max-md:py-2 max-md:px-2.5 px-3.5 border-b border-border'>
                            <p className='text-sm max-md:text-[11px]'><span className='text-secondary-text'>Return Policy:</span> {data?.returnPolicy}<span></span></p>
                        </div>
                        <div className='py-3 max-md:py-2 max-md:px-2.5 px-3.5 border-b border-border'>
                            <p className='text-sm max-md:text-[11px]'><span className='text-secondary-text'>Shipping Information:</span> {data?.shippingInformation}<span></span></p>
                        </div>
                        <div className='py-3 max-md:py-2 max-md:px-2.5 px-3.5 border-b border-border'>
                            <p className='text-sm max-md:text-[11px]'><span className='text-secondary-text'>Warranty Information:</span> {data?.warrantyInformation}<span></span></p>
                        </div>
                        <div className='py-3 max-md:py-2.5 flex-1 flex items-end gap-0.5 md:gap-1 max-lg:items-end max-md:px-2.5 px-3.5'>
                            ...
                            <button onClick={() => dispatch(addToCart(data))} className='px-4 md:px-6 lg:flex-6/7 h-9 md:h-10 lg:h-11 rounded-md md:rounded-lg bg-highlight-blue hover:bg-[#00bbffd5] flex items-center justify-center cursor-pointer'>
