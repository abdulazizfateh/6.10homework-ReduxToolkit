        ...
        likedItems.length > 0 ? <ProductCards data={likedItems} /> :
          <section className='section_liked'>
            <div className='container mx-auto w-full h-[92dvh] flex flex-col gap-3 items-center justify-center'>
              ...
              <button onClick={() => navigate("/")} className='px-3 py-1 md:px-4 md:py-2 rounded-lg border border-border light:border-border-light bg-secondary-bg light:bg-secondary-bg-light cursor-pointer hover:bg-transparent duration-150'>
